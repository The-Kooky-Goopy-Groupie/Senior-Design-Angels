...
export function Setup2() {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FABD27' }}>
            ...
            <Button title=">" onPress={Account} />
        </View >
    );
}

//Sets up Car info
export function Setup3({ navigation }) {
    return (
        <View style={{ flex: 1, backgroundColor: '#FABD27' }}>
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FABD27' }}>
            ...
            <View style={{
                ...
                borderRadius: 12,
                left: '32%',
            }}><Icon iconStyle={{ marginTop: 10 }} name="camera" size={62} color="#5e6472" type="entypo" /></View>
